...
class Redmine():
    ...
    def parse_bug(self, issue_redmine):
        ...
        people = People(issue_redmine["author"]["id"])            
        ...
        try:
                ...
                people =  People(issue_redmine["assigned_to"]["id"])
    ...
    def parse_changes (self, activity):
        ...
        for entry in activity['entries']:
            ...
            # self._parse_html_change(entry['summary'])
            # change = Change(what, old_value, new_value, by, date)
